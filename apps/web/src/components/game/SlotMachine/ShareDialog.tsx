...
export const ShareDialog = ({
  ...
  const shareText =
    `🎰 My Tech Stack Slot Machine Result!\n\n` +
  ...
  const linkedInText =
    `🎰 Just spun the Tech Stack Slot Machine!\n\n` +
          ...
          <div className="flex items-center justify-between bg-gray-800/50 rounded-lg p-3 border border-gray-700/30">
            <div className="flex flex-col gap-1 text-sm">
              <span className="text-gray-400">
                <span className="text-gray-300">{backend.shortName}</span> +{" "}
                <span className="text-gray-300">{frontend.shortName}</span> +{" "}
                <span className="text-gray-300">{database.shortName}</span>
              </span>
            </div>
